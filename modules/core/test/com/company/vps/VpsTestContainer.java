...
public class VpsTestContainer extends TestContainer {

    public VpsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/vps/app.properties",
    ...
    public static class Common extends VpsTestContainer {

        public static final VpsTestContainer.Common INSTANCE = new VpsTestContainer.Common();
